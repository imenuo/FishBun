...
class RadioWithTextButton @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        isSelected {
            canvas.drawCircle((width / 2).toFloat(), (height / 2).toFloat(), (width * 1.2f / 4), circlePaint)
        }
        with(radioType) {
            isRadioText {
                ...
                canvas.drawCircle((width / 2).toFloat(), (height / 2).toFloat(), (width * 1.2f / 4), strokePaint)
            }
        }
    }
